...
function LogIn() {
    ...
    const handleGoogleLogin = () => {
        // add Google logic--go where
        console.log('Google login clicked');
    };

    const handleFacebookLogin = () => {
        // add Facebook  logic--go where
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-8 lg:p-12">
                        ...
                        <div className="space-y-3">
                            ...
                            <button
                                ...
                                className="w-full bg-[#E8E3D8] text-gray-700 py-3 rounded-lg font-medium hover:bg-[#ddd8cd] transition duration-200 flex items-center justify-center gap-2"
                            >
                        ...
                        <div className="mt-6 text-center text-sm text-gray-600">
                            ...
                            <button
                                onClick={() => navigate('/signup')} // make sure to route to sign-in page
